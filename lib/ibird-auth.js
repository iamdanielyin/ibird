...
/**
 * 初始化
 * @param authConfigs 授权配置信息
 * @returns {*}
 */
module.exports.initialize = function (authConfigs) {
...
module.exports.authorization = function () {
    ...
    redis.set(content.access_token, encryptContent, 'ex', authConfigs.expires_in.access_token);
    redis.set(content.refresh_token, encryptContent, 'ex', authConfigs.expires_in.refresh_token);
    return content;
};
