...
exports.initialize = function (configs) {
    ...
    //如果存在客户端目录的话，挂载客户端目录
    if (fs.existsSync(path.resolve(__dirname, '../client'))) {
        app.use('/client', express.static(configs.public));
    }
    //跨域调用
...
exports.start = function () {
    ...
    app.listen(3000, function () {
        console.log(i18n.value('ibird_running', ['3000', 'http://127.0.0.1:3000']));
