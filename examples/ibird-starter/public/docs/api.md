...
``` javascript
{
  ...
  "*refresh_token": "String,更新token",
  "*expires_in_access": "Number,访问token有效秒数",
  "*expires_in_refresh": "Number,刷新token有效秒数",
  "data": "String,额外数据",
  "ts": "String,时间戳",
...
``` javascript
curl -X POST -H "Cache-Control: no-cache" -H "Content-Type: application/x-www-form-urlencoded"
 -d 'code=yinfxs&password=111&email=yinfxs@gmail.com' "http://localhost:3000/preset/token"
————————————————————————————————————————————————————————————————————————————
{
  "_id": "57e2ac2e471795945455cc9d",
  "*access_token": "String,访问token",
...
``` javascript
curl -X PUT -H "Content-Type: application/json" -H "access_token: 84edff70-8014-11e6-9a22-ef95cc3c1a5b"
 -H "Cache-Control: no-cache" -d '{"cond":{"_id":"57e2a90469e9d9d5524778c8"},"doc":{"*access_token":"String,访问token","*refresh_token":"String,更新token","*expires_in_access":"Number,访问token有效秒数","*expires_in_refresh":"Number,刷新token有效秒数","data":"String,额外数据","ts":"String,时间戳","update_ts":"String,更新时间","dr":"String,删除标记"}}' "http://localhost:3000/preset/token"
————————————————————————————————————————————————————————————————————————————
{
  "ok": 1,
  "nModified": 0,
...
``` javascript
curl -X DELETE -H "Content-Type: application/json" -H "access_token: 84edff70-8014-11e6-9a22-ef95cc3c1a5b"
 -H "Cache-Control: no-cache" -d '{"_id":"57e2a90469e9d9d5524778c8"}' "http://localhost:3000/preset/token"
————————————————————————————————————————————————————————————————————————————
{
  "ok": 1,
  "n": 1
...
``` javascript
curl -X GET -H "Content-Type: application/json" -H "access_token: 84edff70-8014-11e6-9a22-ef95cc3c1a5b"
 -H "Cache-Control: no-cache" "http://localhost:3000/preset/token"
————————————————————————————————————————————————————————————————————————————
{
  "data": [
    {
...
``` javascript
curl -X GET -H "Content-Type: application/json" -H "access_token: 84edff70-8014-11e6-9a22-ef95cc3c1a5b"
 -H "Cache-Control: no-cache" "http://localhost:3000/preset/token/57e2ae8db9a9f22d56f45cdf"
————————————————————————————————————————————————————————————————————————————
{
  "_id": "57e2ac2e471795945455cc9d",
  "*access_token": "String,访问token",
